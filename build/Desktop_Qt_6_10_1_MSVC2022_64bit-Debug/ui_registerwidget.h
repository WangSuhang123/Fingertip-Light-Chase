...
public:
    ...
    void retranslateUi(QWidget *RegisterWidget)
    {
        ...
        RegUserNameEdit->setPlaceholderText(QCoreApplication::translate("RegisterWidget", "Enter Username", nullptr));
        groupBox_2->setTitle(QCoreApplication::translate("RegisterWidget", "Password", nullptr));
        RegPassWordEdit->setInputMask(QString());
        RegPassWordEdit->setPlaceholderText(QCoreApplication::translate("RegisterWidget", "Enter Password", nullptr));
        groupBox_3->setTitle(QCoreApplication::translate("RegisterWidget", "Student ID", nullptr));
        RegStudentIDEdit->setPlaceholderText(QCoreApplication::translate("RegisterWidget", "Enter Student ID", nullptr));
        groupBox_4->setTitle(QCoreApplication::translate("RegisterWidget", "School", nullptr));
        RegSchoolNameEdit->setPlaceholderText(QCoreApplication::translate("RegisterWidget", "Enter School Name", nullptr));
        groupBox_5->setTitle(QCoreApplication::translate("RegisterWidget", "E-Mail", nullptr));
        RegEMailEdit->setPlaceholderText(QCoreApplication::translate("RegisterWidget", "Enter Your E-Mail", nullptr));
        groupBox_6->setTitle(QCoreApplication::translate("RegisterWidget", "Verification Code", nullptr));
        RegVerCodeEdit->setPlaceholderText(QCoreApplication::translate("RegisterWidget", "Enter Code", nullptr));
