...
void UserService::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (UserService::*)()>(_a, &UserService::loginSuccess, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (UserService::*)(const QString & )>(_a, &UserService::loginFailed, 1))
            return;
    }
}
...
// SIGNAL 0
void UserService::loginSuccess()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void UserService::loginFailed(const QString & _t1)
{
